 ...
 * @author Owner
 */
public class StudentCheckResult extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentCheckResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
